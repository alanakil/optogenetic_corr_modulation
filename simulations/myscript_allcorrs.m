...
save( ['/scratch/AlanAkil/ArianaVariables_ee_ei_ie_ii_seed_' num2str(seed) '_scale_' num2str(scaling_factor) '_freq_' num2str(laser_freq) '_allcorrs.mat'], 'seed',...
    ...
    'All_corrs_laser_early','All_corrs_laser_late',...
    'All_corrs_control_early','All_corrs_control_late')
