...
Jm=[10 -100; 112.5 -250]/sqrt(N); % Changed old jei to steady state weight jei (-100).
Jxm=[180; 135]/sqrt(N);
...
% EE synapse
Jmax_ee = 10/sqrt(N);
eta_ee=1/1000; % Learning rate of EE
...
rho0=0.020; % Target rate for i cells.
alpha_ie=2*rho0*tauSTDP;
% IE Hebbian
eta_ie_hebbian = 1/1000;
Jmax_ie = 112.5/sqrt(N); % only if hebbian

% II synapse
Jmax_ii = -200/sqrt(N);
eta_ii=0.00075/Jmax_ii; % Learning rate of EI
rho0=0.020; % Target rate for i cells.
...
Jmax_ee = 15/sqrt(N);
Jmax_ie = 135/sqrt(N); % only if hebbian
...
parfor BlockTrial=1:NBlockTrials
    for window = 1:Number_of_points_corr
        ...
        T2=T1+winsize;   % Compute covariances until end of simulation
        tic
        C=SpikeCountCovAriana(s,N,T1,T2,winsize,1:N,BlockTrial,...
...
save( '/scratch/AlanAkil/ArianaVariables_ee_ei_ie_ii.mat', 'mR_BurnPeriod','mC_BurnPeriod',...
    'NBlockTrials','mReeLaser','mReiLaser','mRiiLaser',...
    'mReeControl','mReiControl','mRiiControl','eta_ee','eta_ei','eta_ie_hebbian',...
    'eta_ie_homeo','eta_ii','winsize','T','Total_number_trials','reMean','riMean',...
    'reMeanLaser','ControlTrials','block_slide_size','LaserTrials',...
    'reMeanControl','riMeanLaser','riMeanControl','reMeanBlock','riMeanBlock',...
    'Number_of_points_corr','sliding_window','TotalJei','TotalJee','TotalJie','TotalJii',...
    'JRec_ee_std','JRec_ei_std','JRec_ie_std','JRec_ii_std',...
    'spikeTimes','spikeIndex','reLaserPeriod','riLaserPeriod',...
    'rePostLaserPeriod','riPostLaserPeriod','reMeanControlLaserPeriod',...
    'riMeanControlLaserPeriod','reMeanLaserLaserPeriod',...
    'riMeanLaserLaserPeriod','reMeanControlPostLaser','riMeanControlPostLaser',...
    'reMeanLaserPostLaser','riMeanLaserPostLaser', 'std_E_LP',...
    'std_I_LP', 'std_E_NLP','std_I_NLP','dt','N','TrialTime',...
    'mRLaserPeriod','mRPostLaserPeriod','eRateTime',...
    'iRateTime','laserOnSet', 'mR_laserPairs_Control','mR_nonlaserPairs_Control',...
    'mR_laserPairs_Laser','mR_nonlaserPairs_Laser', ...
    'mR_stderr_laserPairs_Control',...
    'mR_stderr_nonlaserPairs_Control','mR_stderr_laserPairs_Laser','mR_stderr_nonlaserPairs_Laser',...
    'mC_laserPairs_Control','mC_nonlaserPairs_Control','mC_laserPairs_Laser',...
    'mC_nonlaserPairs_Laser',...
    'mC_stderr_laserPairs_Control','mC_stderr_nonlaserPairs_Control','mC_stderr_laserPairs_Laser',...
    'mC_stderr_nonlaserPairs_Laser',...
    'Variance_laserPairs_Control', 'Variance_nonlaserPairs_Control',...
    'Variance_laserPairs_Laser','Variance_nonlaserPairs_Laser',...
    'Variance_stderr_laserPairs_Control', 'Variance_stderr_nonlaserPairs_Control',...
    'Variance_stderr_laserPairs_Laser','Variance_stderr_nonlaserPairs_Laser',...
    'rate_LaserPairs','rate_nonLaserPairs',...
    'FR_laserPairs_Laser', 'FR_laserPairs_Control',...
    'IeCurrent','IiCurrent','IxCurrent')
